...
//    gradient.colors = [NSArray arrayWithObjects:(id)[_gradColor1 CGColor], (id)[_gradColor2 CGColor], nil];
//    
//    gradient.startPoint = CGPointMake(0, 0);
//    gradient.endPoint =  CGPointMake(0, 1);
//    [self.layer insertSublayer:gradient atIndex:0];
//    
//    //self.layer.cornerRadius = _roundCornerVal;
//    
...
-(MBCircularProgressBarLayer*)progressLayer{
    ...
    layer.tempLayer = (AngleGradientLayer *)self.layer;;
    return layer;
}
